			...
			try {
				...
				if (portIdentifier.isCurrentlyOwned()) {
					...
					if (commPort instanceof SerialPort) {
						...
						System.out.println("DATABITS : " + selectedSetting.getDataBits() +" / " + CommonUtil.portSettingVlues("DATABITS", selectedSetting.getDataBits()));
						System.out.println("STOPBITS : " + selectedSetting.getStopBits() + " / " + CommonUtil.portSettingVlues("STOPBITS", selectedSetting.getStopBits()));
						System.out.println("PARITY_NONE : " + selectedSetting.getParity() + " / " + CommonUtil.portSettingVlues("PARITY_NONE", selectedSetting.getParity()));
						
						serialPort.setSerialPortParams
						(
							Integer.parseInt(selectedSetting.getBaudRate()), 							// 통신속도
				...
				while( true ) {
					...
					try {
						...
						if( CommonUtil.checksumConfirm(bufferToString) ) {
							// 입력 전압
							middlePanel.info_input_volt.setText(CommonUtil.stringToASCII(
									bufferToString[5],bufferToString[6],bufferToString[7],bufferToString[8]).toString());
							
							// 전류
							middlePanel.info_electric_current.setText(CommonUtil.stringToASCII(
									bufferToString[9],bufferToString[10],bufferToString[11],bufferToString[12]).toString());
							
							// 출력 전압
							middlePanel.info_output_volt.setText(CommonUtil.stringToASCII(
									bufferToString[13],bufferToString[14],bufferToString[15],bufferToString[16]).toString());
							
							// 온도(방열판)
							middlePanel.info_first_temperature.setText(CommonUtil.stringToASCII(
									bufferToString[17],bufferToString[18],bufferToString[19],bufferToString[20]).toString());
							
							// 온도(CAP)
							middlePanel.info_second_temperature.setText(CommonUtil.stringToASCII(
									bufferToString[21],bufferToString[22],bufferToString[23],bufferToString[24]).toString());
							
							
							// 입력 전압
							monitoringPanel.infoInputVoltData.setText(CommonUtil.stringToASCII(
									bufferToString[5],bufferToString[6],bufferToString[7],bufferToString[8]).toString());
							
							// 전류
							monitoringPanel.infoElectricCurrentData.setText(CommonUtil.stringToASCII(
									bufferToString[9],bufferToString[10],bufferToString[11],bufferToString[12]).toString());
							
							// 출력 전압
							monitoringPanel.infoOutputVoltData.setText(CommonUtil.stringToASCII(
									bufferToString[13],bufferToString[14],bufferToString[15],bufferToString[16]).toString());
							
							// 온도(방열판)
							monitoringPanel.infoFirstTemperatureData.setText(CommonUtil.stringToASCII(
									bufferToString[17],bufferToString[18],bufferToString[19],bufferToString[20]).toString());
							
							// 온도(CAP)
							monitoringPanel.infoSecondTemperatureData.setText(CommonUtil.stringToASCII(
									bufferToString[21],bufferToString[22],bufferToString[23],bufferToString[24]).toString());
